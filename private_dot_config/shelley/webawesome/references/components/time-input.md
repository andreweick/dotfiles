...
Stable [Forms](https://webawesome.com/docs/components/?category=forms) [Since 3.8](https://webawesome.com/docs/resources/changelog#wa_380)
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.14.0/components/time-input/time-input.js';
```
