...
Stable [Navigation](https://webawesome.com/docs/components/?category=navigation) [Since 3.11](https://webawesome.com/docs/resources/changelog#wa_3110)
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.14.0/components/pagination/pagination.js';
```
